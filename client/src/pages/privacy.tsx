...
export default function PrivacyPage() {
  ...
  const sections = isRu
    ? [
        ...
        ["2. Что хранится", "Мы можем хранить только технические настройки интерфейса, например выбранный язык и тему, в localStorage браузера. Эти данные не содержат содержимое ваших PDF."],
    ...
    : [
        ...
        ["2. What is stored", "We may store interface preferences such as language and theme in browser localStorage. Those values do not include the contents of your PDF files."],
