...
const en: Translations = {
  ...
  hero: {
    ...
    sub: "28 powerful PDF tools. Merge, split, compress, convert, and protect your PDFs — all processed locally in your browser. Your files never touch our servers.",
  ...
  tools: { title: "Every PDF Tool You'll Ever Need", sub: "28 tools across 7 categories. Free to use, no sign-up required.", allTools: "All Tools" },
  why: {
...
const ru: Translations = {
  ...
  hero: {
    ...
    sub: "28 мощных PDF инструментов. Объединяйте, разделяйте, сжимайте, конвертируйте и защищайте PDF — всё обрабатывается локально в вашем браузере. Ваши файлы никогда не попадают на наши серверы.",
  ...
  tools: { title: "Все PDF инструменты в одном месте", sub: "28 инструментов в 7 категориях. Бесплатно, без регистрации.", allTools: "Все инструменты" },
  why: {
    title: "Почему PDFX?",
...
const translationMap: Record<LangCode, Translations | PartialTranslations> = {
  en,
  ru,
